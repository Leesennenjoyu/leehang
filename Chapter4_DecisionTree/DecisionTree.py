...
if __name__ == '__main__':
    ...
    trainDataList, trainLabelList = loadData('/Users/leesennenjoyu/Words_Words/dataset/mnist_train.csv')

    testDataList, testLabelList = loadData('/Users/leesennenjoyu/Words_Words/dataset/mnist_test.csv')
